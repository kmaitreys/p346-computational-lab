...
def rootBisec(y, a, b, e):
    ...
    #this part of the code executes the bracketing algorithm 
        ...
        if abs(y(a))<abs(y(b)):
            a = a - 1.1*(b-a)
            rootBisec(y, a, b, e) #call rootBisec again and this process continues until the bracketing is complete
        if abs(y(a))>abs(y(b)):
            b = b + 1.1*(b-a)
            rootBisec(y, a, b, e) #call rootBisec again and this process continues until the bracketing is complete
...
def rootRegFalsi(y, a, b, e):

    #this part of the code is to print the plot and the table

    if y(a)*y(b)<0: #no bracketing needed
        iterCount, xiCount = regfalsi(y, a, b, e, 100) #y is function, a and b represent the interval. 
    ...
    #this part of the code executes the bracketing algorithm
        ...
        if abs(y(a))<abs(y(b)): 
            ...
            rootRegFalsi(y, a, b, e) #call rootBisec again and this process continues until the bracketing is complete
        if abs(y(a))>abs(y(b)):
            b = b + 1.1*(b-a)
            rootRegFalsi(y, a, b, e) #call rootBisec again and this process continues until the bracketing is complete
